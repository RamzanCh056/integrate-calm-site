...
const DonorsDropdown = () => {
  ...
  const sortedByAmount = [...donors].sort((a, b) => b.amount - a.amount);
        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              className="absolute right-0 top-full mt-2 w-72 rounded-2xl bg-card border border-border shadow-calm-lg z-50"
            >
              <div className="p-3 border-b border-border">
                <p className="font-display text-sm font-bold text-foreground">Top Donors</p>
              ...
              {donors.length > 5 && (
                <div className="p-2 border-t border-border">
                  <button
                    ...
                    className="block w-full text-center font-body text-xs font-medium text-primary hover:underline py-1"
                  >
